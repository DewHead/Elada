...
- **On-Blur PDF Preview:** A zero-flicker visual representation of the invoice that updates seamlessly when the user clicks out of an input field, ensuring focus is never lost during typing.
